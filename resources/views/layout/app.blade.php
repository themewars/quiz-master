        ...
        <nav class="container">
            ...
            <div class="header-menu">
                ...
                <div class="auth-buttons">
                    ...
                    @endauth
                    <button class="mobile-menu-toggle mobile-only" type="button" aria-label="Open menu" title="Open menu">
                ...
                @if (getSetting() &&
                    ...
                    <div class="social-media">
                        @if (getSetting() && getSetting()->facebook_url)
                            <a href="{{ getSetting()->facebook_url }}" target="_blank" aria-label="Facebook" title="Facebook">
                        ...
                        @if (getSetting() && getSetting()->twitter_url)
                            <a href="{{ getSetting()->twitter_url }}" target="_blank" aria-label="Twitter" title="Twitter">
                                <svg width="20" height="20" viewBox="0 0 24 24" fill="none">
                                    <path
                        ...
                        @if (getSetting() && getSetting()->linkedin_url)
                            <a href="{{ getSetting()->linkedin_url }}" target="_blank" aria-label="LinkedIn" title="LinkedIn">
                                <svg width="20" height="20" viewBox="0 0 24 24" fill="none">
                                    <path
                        ...
                        @if (getSetting() && getSetting()->instagram_url)
                            <a href="{{ getSetting()->instagram_url }}" target="_blank" aria-label="Instagram" title="Instagram">
                                <svg width="20" height="20" viewBox="0 0 24 24" fill="none">
