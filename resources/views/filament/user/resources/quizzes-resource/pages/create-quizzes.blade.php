<x-filament-panels::page>
    ...
    <script>
        ...
        function startProgressMonitoring() {
            ...
            progressCheckInterval = setInterval(checkProgress, 2000); // Check every 2 seconds
        }
        ...
        function checkProgress() {
            ...
            .then(data => {
                if (data.quiz) {
                    ...
                    // No processing quiz found, stop monitoring
        ...
        // Listen for form submission to start monitoring
        document.addEventListener('DOMContentLoaded', function() {
            const form = document.querySelector('form');
            if (form) {
                form.addEventListener('submit', function() {
                    // Start monitoring after a short delay to allow the quiz to be created
