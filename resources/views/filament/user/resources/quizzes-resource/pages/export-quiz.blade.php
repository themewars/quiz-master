<x-filament-panels::page>
    <div class="space-y-6">
        ...
        <div class="bg-white rounded-lg shadow p-6">
            ...
            <div class="prose max-w-none border border-gray-200 rounded-lg p-4" wire:key="preview-{{ $this->form->getState()['includeInstructions'] ?? 'false' }}-{{ $this->form->getState()['exportFormat'] ?? 'pdf' }}-{{ $this->form->getState()['exportTemplate'] ?? 'standard' }}">
                {!! $this->previewHtml !!}
            </div>
        </div>
