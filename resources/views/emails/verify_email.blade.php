                                ...
                                <tr>
                                    <td class="content-cell"
                                        ...
                                        <p
                                            ...
                                            {{ __('messages.mail.hello') . '!' }}</p>
                                        <p
                                            style="box-sizing: border-box; font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, Helvetica, Arial, sans-serif, 'Apple Color Emoji', 'Segoe UI Emoji', 'Segoe UI Symbol'; position: relative; font-size: 16px; line-height: 1.5em; margin-top: 0; text-align: left;">
                                            {{ __('messages.mail.click_the_button_below_to_verify_your_email_address') }}
                                        </p>
                                                                    ...
                                                                    <tr>
                                                                        <td
                                                                            ...
                                                                            <a href="{{ $url }}"
                                                                                ...
                                                                                {{ __('messages.mail.verify_email_address') }}</a>
                                                                        </td>
                                                                    </tr>
                                                                </table>
                                                            </td>
                                        ...
                                        <p
                                            style="box-sizing: border-box; font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, Helvetica, Arial, sans-serif, 'Apple Color Emoji', 'Segoe UI Emoji', 'Segoe UI Symbol'; position: relative; font-size: 16px; line-height: 1.5em; margin-top: 0; text-align: left;">
                                            {{ __('messages.mail.if_you_did_not_create_an_account') }}</p>
                                        <p
                                            style="box-sizing: border-box; font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, Helvetica, Arial, sans-serif, 'Apple Color Emoji', 'Segoe UI Emoji', 'Segoe UI Symbol'; position: relative; font-size: 16px; line-height: 1.5em; margin-top: 0; text-align: left;">
                                            {{ __('messages.mail.regards') }}<br>
                                            {{ config('app.name') }}</p>
                                                ...
                                                <td
                                                    ...
                                                    <p
                                                        ...
                                                        {{ __('messages.mail.trouble', [
                                                            'actionText' => Lang::get('messages.mail.verify_email_address'),
                                                        ]) }}
                                                        <a href="{{ $url }}"
                                                            style="box-sizing: border-box; font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, Helvetica, Arial, sans-serif, 'Apple Color Emoji', 'Segoe UI Emoji', 'Segoe UI Symbol'; position: relative; color: #3869d4;">{{ $url }}</a>
                                                    </p>
